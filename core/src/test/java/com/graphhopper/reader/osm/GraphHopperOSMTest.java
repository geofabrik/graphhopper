...
public class GraphHopperOSMTest {
    ...
    public void testUnloadProfile() {
        ...
        instance.load();
        assertEquals(5, instance.getBaseGraph().getNodes());
        assertEquals("road_class,road_environment,roundabout,car_access,road_class_link,max_speed,layer,foot_subnetwork,car_subnetwork",
    ...
    public void testFailsForWrongEVConfig() {
        ...
        instance.load();
        assertEquals(5, instance.getBaseGraph().getNodes());
        assertEquals("road_class,road_environment,roundabout,car_access,road_class_link,max_speed,layer,car_subnetwork", instance.getEncodingManager().getEncodedValues().stream().map(EncodedValue::getName).collect(Collectors.joining(",")));
    }
